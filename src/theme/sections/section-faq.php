...
if( $display):
?>
<section id="<?php echo $section_id?>" data-quicklink-on="<?php echo $jump_link_display?>" data-quicklink-name="<?php echo $jump_link_name?>" class="faq section-h-padding <?php echo $margin_class;?> color-brand-primary">
