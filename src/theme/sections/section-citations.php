...
<section id="<?php echo $section_id?>" class="citations section-h-padding section-v-margin color-brand-primary">
    <div class="citations__inner section-1080" data-aos="fade" data-aos-delay="200" data-aos-duration="750" data-aos-easing="cubic">
        <div class="section-860" data-aos="smooth-slide-up" data-aos-delay="400" data-aos-duration="750" data-aos-easing="cubic">
            <?php
