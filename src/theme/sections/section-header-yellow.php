...
<section class="header-simple-yellow color-brand-primary" id="<?php echo $section_id?>">
    <div class="header-simple-yellow__inner section-h-padding layout--1440" data-aos="smooth-slide-up" data-aos-delay="350" data-aos-duration="500" data-aos-easing="cubic">
        <?php
            echo '<div class="section-1080 header-simple-yellow__content">';
